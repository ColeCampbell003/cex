/*
Title: mtbi_topcode_cex.do
Purpose: Create topcode indicators consistent with Coibon et al. (2012).
Author: Cole Campbell
Date Last Modified:08-11-2020
*/

* ===============================================================
* topcode consumption variables consistent with Coibon et al. (2012)
* ===============================================================

/*NON-DURABLE CONSUMPTION*/
* food at home
	gen cgk_foodhomeT = (cost_=="T") if ///
...
* entertainment durables
	gen cgk_entertainDT = (cost_=="T") if ///
...
* entertainment services
	gen cgk_entertainST = (cost_=="T") if ///
...
* financial services
	gen cgk_financialST = (cost_=="T") if ///
...
* health insurance expenses
	gen cgk_healthinsT = (cost_=="T") if  /// /*bcbs = blue cross blue shield*/
...
* household expenditures (durables)
	gen cgk_houseexpDT = (cost_=="T") if /// /*maintenance and repair commodities*/
...
* rental expenditures (services)
	gen cgk_rentexpST = (cost_=="T") if /// /*maintenance, insurance and other expense*/
...
* rent paid
	gen cgk_rentpaidT = (cost_=="T") if /// 
		ucc==210110 // rent
		
		
* life insurance
	gen cgk_lifeinsT = (cost_=="T") if ///
		ucc==700110 | /// life, endowment, annuity, or other pesonal insurance
		ucc==2120     // other non-health insurance
		
* pensions 
	gen cgk_pensionsT = (cost_=="T") if 	/// pensions	pensions and social security
...
* vehicle expenditures (durables)
	gen cgk_vehexpDT = (cost_=="T") if ///		/*maintenance and repairs*/
...
* vehicle expenditures (services)
	gen cgk_vehexpST = (cost_=="T") if ///
		...
		ucc==500110	| /// vehicle insurance	/*vehicle insurance*/
		ucc==510110	| /// automobile finance charges	/*vehicle finance charges*/
		ucc==510901	| /// truck finance charges	*/
		ucc==510902	| /// motorcycle and plane finance charges	*/
		...
		ucc==620113	  // automobile service clubs
